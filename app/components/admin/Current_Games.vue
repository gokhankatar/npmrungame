  ...
  <v-row class="d-flex justify-center align-center mx-auto mt-5 mt-lg-10">
    ...
    <v-col cols="12" lg="10">
      <Admin_Bulk_Delete_Bar
        ...
        :total-count="currentGames.length"
        @select-all="selectAll(currentGames)"
...
const COLLECTION_NAME = "current_games";
...
const bulkDeletePreviewGames = computed(() =>
  getSelectedFromList(currentGames.value).slice(0, 12)
);
...
const deleteSelectedGamesFromDb = async () => {
  const selected = getSelectedFromList(currentGames.value);
