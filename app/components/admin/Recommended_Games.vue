<template>
  <v-row class="d-flex justify-center align-center mx-auto mt-5 mt-lg-10">
    <v-col cols="12" lg="10" class="d-flex justify-space-between align-center">
      <div class="d-flex align-center justify-center justify-sm-start ga-2 ga-lg-5 mt-2 mt-lg-5">
        ...
        <p class="shadowed-text text-subtitle-2 text-sm-subtitle-1 text-lg-h5 text-xl-h4 default-title-letter">
          Önerilen Oyunlar
          <strong class="font-weight-bold default-title-letter">({{ recommendedGames?.length }})</strong>
        </p>
      </div>
      ...
      <div class="d-flex align-center ga-1 ga-lg-2">
        ...
        <v-btn icon="mdi-refresh" class="rounded text-caption text-lg-subtitle-2" :ripple="false" variant="text"
          rounded="xl" :color="isGettingRecommendedGames ? 'green-accent-2' : 'grey-lighten-1'"
          @click="getRecommendedGames" :size="smallScreen ? 'x-small' : 'small'" :loading="isGettingRecommendedGames" />
      </div>
    </v-col>
    ...
    <v-col cols="12" lg="10">
      <Admin_Game_Table :loading="isGettingRecommendedGames" :arr="recommendedGames" :onDeleteClick="handleDeleteGame"
