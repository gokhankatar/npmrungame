<template>
  <div class="navbar d-flex justify-space-between align-center mx-auto rounded px-1 px-lg-5 px-xl-8"
    :class="isScrolledToBottom ? 'scrolled-navbar' : ''">
    <img :src="otherLogoImg" width="90" class="cursor-pointer" @click="router.replace('/')" />
    ...
    <v-btn class="rounded d-flex d-lg-none" icon="mdi-menu" variant="tonal" :ripple="false" size="small" />
  </div>
</template>
