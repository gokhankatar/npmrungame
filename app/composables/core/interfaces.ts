...
export interface StoreNpmRunGame {
  ...
  active_game_genre: {
    title: "Aksiyon" | "Strateji" | "Nişancı" | "Indie" | "Rol Yapma" | "Macera" | "Korku" | "Souls-Like" | null,
    slug: "action" | "strategy" | "adventure" | "shooter" | "indie" | "rpg" | "horror" | "souls-like" | null
  }
}
...
export interface Game_Genre {
  name: "Aksiyon" | "Strateji" | "Nişancı" | "Indie" | "Rol Yapma" | "Macera" | "Korku" | "Souls-Like"
  slug: "action" | "strategy" | "adventure" | "shooter" | "indie" | "rpg" | "horror" | "souls-like",
